...
df_hb_long1 %>% 
  ...
  # ggtitle("Figure 1: Hemoglobin by Gestational Age by site") +
...
df_hb_long1 %>% 
  ...
  xlab("Hemoglobin (g/dL)") +
  ylab("Density")+
  # ggtitle("Figure 3: Kernel Density Plots of Hemoglobin by Site ") +
...
newpar <- par(mfrow = c(2, 2), 
              ...
              cex.main = 1.5)
#site 
# centiles_fun(fpr_mod_pooled, df_fpr, "Centile Curves - Pooled")
